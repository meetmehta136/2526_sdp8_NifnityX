...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Force a full reload to allow App.jsx to pick up the new auth cookies
  ...
  return (
    <div className="flex w-full h-screen bg-black overflow-hidden font-sans">
      ...
      <AuthHeroSide title="IDENT_CREATION: INITIALIZING..." scrambleChars="Y_Z#71$" />

      {/* Right Partition (40%) - Signup Form (Exactly from Inspiration) */}
      <div className="w-full lg:w-[40%] h-full flex items-center justify-center bg-zinc-950 p-8 sm:p-12 relative overflow-y-auto select-none">
        <div className="flex flex-col gap-6 w-full max-w-sm mx-auto animate-fade-in-up">
          <div className="flex flex-col items-center gap-2 mb-4">
            ...
            <h1 className="text-3xl font-bold text-white tracking-tight font-['JetBrains_Mono']">Create an account</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <p className="text-xs text-zinc-500 italic opacity-70">
          ...
          <div className="text-balance text-center text-xs text-zinc-500 mt-8 [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-zinc-400 px-4">
